...
public class BillDeleteFrame extends JPanel implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource() == contorl) {
			try {
				...
				if(new BillMana().delete(Integer.parseInt(timeT.getText()))) {
					new MyDialog("删除成功!");
					return;
				}
